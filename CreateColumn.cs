...
namespace IT_Lab_Stage_2
{
    public partial class CreateColumn : Form
    {
        ...
        public CreateColumn(string columnName, ColumnType columnType, List<string> availablesValues)
        {
            ...
            availableValuesTextBox.Text = string.Join(Convert.ToString(','), availablesValues);
        }
        private void Create(object sender, EventArgs e)
        {
            ...
            AvailableValues = availableValuesTextBox.Text.Split(',', (char)StringSplitOptions.RemoveEmptyEntries).ToList();
        }
